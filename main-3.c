...
double func(double x) {                                                     //double gew�hlt zwecks Genauigkeit
...
double der(double x) {                                                      //double gew�hlt zwecks genauigkeit
...
int main() {
   ...
   // printf("Ihre Eingabe war: %d, %d, %d, \n",a,b,c);
    ...
    if (max_wiederholungen >= 20) {
        printf("Eingabe war h�her als 20.\nErneute Eingabe (unter 20): ");
        scanf("%d", &max_wiederholungen);
        if (max_wiederholungen >= 20);
    ...
    if (fabs(values[max_wiederholungen] - values[max_wiederholungen - 1]) <= tol) { //wie pr�zise arbeitet das Programm
        ...
        printf("%d -te Wiederholung ist: %.8f\n", max_wiederholungen, values[max_wiederholungen]);
        printf("%d -te Wiederholung ist: %.8f\n", max_wiederholungen - 1, values[max_wiederholungen - 1]);
        printf("Der m�gliche Fehler in der Sch�tzung betr�gt:  %.8f\n", fabs(values[max_wiederholungen] - values[max_wiederholungen - 1]));
